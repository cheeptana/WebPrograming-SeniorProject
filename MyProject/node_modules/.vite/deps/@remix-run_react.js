...
function getSingleFetchDataStrategy2(manifest, routeModules) {
  return async ({
    request,
    matches
...
function RemixBrowser(_props) {
  if (!router) {
    ...
    router = createRouter({
      ...
      hydrationData,
      mapRouteProperties,
      unstable_dataStrategy: window.__remixContext.future.unstable_singleFetch ? getSingleFetchDataStrategy2(window.__remixManifest, window.__remixRouteModules) : void 0,
      ...isFogOfWarEnabled2 ? {
