        ...
        <section className="bg-gray-100 py-8">
          <div className="container mx-auto text-center">
            ...
            <div className="flex justify-center space-x-4 mb-8">
              <a href="#" className="text-gray-700">Robot</a>
              <a href="#" className="text-gray-700">Magic</a>
              <a href="#" className="text-gray-700">Dinosaur</a>
              <a href="#" className="text-gray-700">Other</a>
            </div>
        ...
        <main className="bg-gray-100 py-16">
                        <div className="container mx-auto">
                            ...
                            <div className="mt-16 text-center">
                                ...
                                <button className="bg-pink-500 text-white py-2 px-4 rounded-full">Login Now</button>
                            </div>
